...
class SearchResult:
    ...
    def search_query_platform(fullname:str,platform):
        ...
        with open(f"{platform}.json", "w", encoding="utf-8") as fp:
...
def main():
    max_processes = 3  # Adjust this based on your needs
    # targets = ["linkedin", "twitter", "tiktok"]
    targets = ["reddit"]
